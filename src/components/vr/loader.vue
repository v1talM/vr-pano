<template lang="html">
  <div class="vr-loader vertical-centered-box">
    <div class="content">
...
<style lang="css">
.vr-loader.vertical-centered-box {
  position: absolute;
  width: 100%;
  height: 100%;
  text-align: center;
...
.vr-loader.vertical-centered-box .content {
  position: relative;
  width: 50px;
  height: 50px;
...
.vr-loader.vertical-centered-box .loader-circle{
  position: absolute;
  width: 100%;
  height: 100%;
  color: #fff;
